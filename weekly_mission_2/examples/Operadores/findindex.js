...
/* Contrario al ejemplo 12, en este método regresa la posición NO el valor.*/

const result2 = names13.find((name) => name.length > 7)
console.log("Ejemplo 13: Primer elemento cuya palabra sea mayor a 7 es "+ result2)